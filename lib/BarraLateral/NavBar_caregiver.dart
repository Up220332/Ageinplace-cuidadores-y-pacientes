...
import '../Cuidador/screen_ModTelefono.dart';
...
class NavBarCaregiver extends StatefulWidget {
  const NavBarCaregiver({super.key});

  @override
  _NavBarCaregiverState createState() => _NavBarCaregiverState();
}
...
class _NavBarCaregiverState extends State<NavBarCaregiver> {
  ...
  void initState() {
    ...
    // Listener para cuando cambie el idioma
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            // Header con gradiente - VERSIÓN CORREGIDA Y MÁS GRANDE
            Container(
                ...
                children: <Widget>[
                  ...
                  _buildSubMenuItem(
                    ...
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ModTlfnCuidadorScreen(),
                      ),
                    ),
                  ),
                  _buildSubMenuItem(
