...
class ModTlfnCuidadorPacienteScreen extends StatefulWidget {
  const ModTlfnCuidadorPacienteScreen({super.key});

  @override
  State<ModTlfnCuidadorPacienteScreen> createState() =>
      _ModTlfnCuidadorPacienteScreenSate();
}

class _ModTlfnCuidadorPacienteScreenSate
    extends State<ModTlfnCuidadorPacienteScreen> {
                      ...
                      _mostrarDialogo(
                        ...
                        onAccept: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => WearablePacientePacienteScreen(),
                            ),
                          );
                        },
                      );
